...
void cancel (void);
void ex_it(void);
void gotoxy(short x, short y)//used to place the control cursor to a required position on the console screen.
{
	COORD pos ={x,y};//sets co-ordinates in (x,y)
	SetConsoleCursorPositin(GetStdHandle(STD_OUTPUT_HANDLE),POS);
}
